    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5">
            <span className="text-xs text-primary/40">Stadium Goods</span>
            <span className="text-xs text-primary/40">Sneakersnstuff</span>
            <span className="text-xs text-primary/40">Superkicks</span>
            <span className="text-xs text-primary/40">Mainstreet</span>
            <span className="text-xs text-primary/40">Limited Edt</span>
            <Link to="/browse" className="text-xs text-accent hover:text-primary transition-colors">+ 16 more</Link>
          </div>
        </div>
        <div>
